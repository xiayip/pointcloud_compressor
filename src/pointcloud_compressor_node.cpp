...
{
public:
  explicit PointCloudCompressorNode(const rclcpp::NodeOptions& options)
      : Node("pointcloud_compressor_node", options)
  {
    // Declare parameters
...
RCLCPP_COMPONENTS_REGISTER_NODE(PointCloudCompressorNode)